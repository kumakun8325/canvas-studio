      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md dark:shadow-gray-900/50 text-center max-w-md">
          ...
          <button
            ...
            className="inline-flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm dark:text-gray-100"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {projects.map((project) => (
                <div
                  ...
                  className="bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:shadow-gray-900/50 hover:shadow-md transition-shadow cursor-pointer group"
                >
