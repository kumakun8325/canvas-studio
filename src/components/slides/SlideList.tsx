...
export function SlideList() {
  ...
  return (
    <div className="shrink-0 w-40 lg:w-52 min-w-40 lg:min-w-52 bg-gray-50 dark:bg-gray-900 border-r dark:border-gray-700 p-2 overflow-y-auto">
      ...
      <button
        onClick={addSlide}
        className="w-full mt-2 py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded text-gray-500 dark:text-gray-400 hover:border-blue-400 dark:hover:border-blue-500 hover:text-blue-500 dark:hover:text-blue-400 transition-colors text-sm"
      >
        + 追加
      </button>
    </div>
